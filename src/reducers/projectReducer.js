...
export const reducer = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case UPDATE_DATE_TIMELINE: {
      ...
      const decreasingValues = objectUtil.checkForDecreasingValues(changes,isAdd,field,state.disabledDates,oldDate,newDate,moveToPast,projectSize,filteredAttributeData,state.currentProject.deadlines);
