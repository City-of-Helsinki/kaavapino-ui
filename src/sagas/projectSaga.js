...
function* getProjectDisabledDeadlineDates() {
  try {
    ...
    console.log(dates?.date_types?.lomapäivät?.dates)
    yield put(fetchDisabledDatesSuccess(dates?.date_types?.disabled_dates?.dates, dates?.date_types?.lomapäivät?.dates));
  } catch (e) {
