...
describe('generateConfirmedFields utility function', () => {
    ...
    test("generateConfirmedFields returns correct fields when some are confirmed", () => {
        ...
        const confirmed = [
            "vahvista_periaatteet_esillaolo_alkaa", "vahvista_periaatteet_esillaolo_alkaa_2",
            "vahvista_periaatteet_lautakunnassa", "vahvista_periaatteet_lautakunnassa_2",
            "vahvista_oas_esillaolo_alkaa",
            "vahvista_luonnos_esillaolo_alkaa", "vahvista_luonnos_esillaolo_alkaa_2", "vahvista_luonnos_esillaolo_alkaa_3",
            "vahvista_kaavaluonnos_lautakunnassa", "vahvista_kaavaluonnos_lautakunnassa_2", "vahvista_kaavaluonnos_lautakunnassa_3",
        ...
        expect.soft(result).toContain("milloin_periaatteet_esillaolo_paattyy");
        expect.soft(result).toContain("viimeistaan_mielipiteet_periaatteista");
        expect.soft(result).toContain("milloin_periaatteet_esillaolo_alkaa_2");
        expect.soft(result).not.toContain("milloin_periaatteet_esillaolo_alkaa_3");
        expect.soft(result).not.toContain("milloin_periaatteet_esillaolo_alkaa_4");

        expect.soft(result).toContain("milloin_periaatteet_lautakunnassa");
        expect.soft(result).toContain("periaatteet_lautakunta_aineiston_maaraaika");
                
        expect.soft(result).toContain("milloin_periaatteet_lautakunnassa_2");
        expect.soft(result).not.toContain("milloin_periaatteet_lautakunnassa_3");
        expect.soft(result).not.toContain("milloin_periaatteet_lautakunnassa_4");

        expect.soft(result).toContain("oas_esillaolo_aineiston_maaraaika");
        expect.soft(result).toContain("milloin_oas_esillaolo_alkaa");
        expect.soft(result).toContain("milloin_oas_esillaolo_paattyy");
        expect.soft(result).not.toContain("milloin_oas_esillaolo_alkaa_2");
        expect.soft(result).not.toContain("milloin_oas_esillaolo_alkaa_3");

        expect.soft(result).toContain("milloin_luonnos_esillaolo_alkaa");
        expect.soft(result).toContain("milloin_luonnos_esillaolo_alkaa_2");
        expect.soft(result).toContain("milloin_luonnos_esillaolo_alkaa_3");
        expect.soft(result).not.toContain("milloin_luonnos_esillaolo_alkaa_4");
        expect.soft(result).toContain("milloin_kaavaluonnos_lautakunnassa");
        expect.soft(result).toContain("milloin_kaavaluonnos_lautakunnassa_2");
        expect.soft(result).toContain("milloin_kaavaluonnos_lautakunnassa_3");
        expect.soft(result).not.toContain("milloin_kaavaluonnos_lautakunnassa_4");

        expect.soft(result).not.toContain("milloin_kaavaehdotus_lautakunnassa");
        expect.soft(result).not.toContain("milloin_kaavaehdotus_lautakunnassa_2");
        expect.soft(result).toContain("milloin_ehdotuksen_nahtavilla_alkaa_iso");
        expect.soft(result).not.toContain("milloin_ehdotuksen_nahtavilla_alkaa_iso_2");
        expect.soft(result).not.toContain("milloin_ehdotuksen_nahtavilla_alkaa_iso_3");
        expect.soft(result).not.toContain("milloin_ehdotuksen_nahtavilla_alkaa_iso_4");

        expect.soft(result).toContain("milloin_tarkistettu_ehdotus_lautakunnassa");
        expect.soft(result).toContain("milloin_tarkistettu_ehdotus_lautakunnassa_2");
        expect.soft(result).not.toContain("milloin_tarkistettu_ehdotus_lautakunnassa_3");
        expect.soft(result).not.toContain("milloin_tarkistettu_ehdotus_lautakunnassa_4");
